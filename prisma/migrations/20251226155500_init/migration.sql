...
-- CreateEnum
CREATE TYPE "DeliveryStatus" AS ENUM ('NOT_STARTED', 'PENDING', 'IN_PROGRESS', 'COMPLETED');
...
-- CreateIndex
CREATE UNIQUE INDEX "CartItem_cartId_productId_colorVariant_key" ON "CartItem"("cartId", "productId", "colorVariant");
